                ...
                <div class="question-card">
                    <div class="question-header">
                        <div style="display: flex; flex-direction: column; gap: 5px;">
                            ...
                            @if($item->nomor_tiket)
                                <span
                                    style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 4px 10px; border-radius: 15px; font-size: 0.8em; font-weight: 600; display: inline-block; width: fit-content;">
                                    🎫 {{ $item->nomor_tiket }}
                                </span>
                            @endif
                        </div>
                    ...
                    @if($item->gambar)
                        <div class="question-image">
                            ...
                            <img src="{{ asset($item->gambar) }}" alt="Screenshot Pertanyaan"
                    ...
                    @if($item->jawaban)
                        <div class="question-content" style="background: #e8f4f8; border-left: 4px solid #28a745;">
                            ...
                            <small style="color: #666; margin-top: 10px; display: block;">
                                <em>Dijawab oleh: {{ $item->replied_by ?? 'Admin' }} pada
                                    {{ $item->replied_at ? $item->replied_at->format('d/m/Y H:i') : '-' }}</em>
                            </small>
                        </div>
                        ...
                        @if($item->gambar_jawaban)
                            <div class="question-image">
                                ...
                                <img src="{{ asset($item->gambar_jawaban) }}" alt="Screenshot Jawaban"
                    ...
                    <div class="status-actions">
                        @if($item->jawaban)
                            <span class="btn-update-status disabled" style="text-decoration: none; display: inline-block;">
                                Sudah Dijawab
                            </span>
                        @else
                            <a href="{{ route('layanan.reply', $item->id) }}" class="btn-update-status"
